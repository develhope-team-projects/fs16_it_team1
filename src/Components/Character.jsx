...
export function Character({hero}){
    ...
    return(
        <div className="container-hero">
            {hero === HERO.PALADIN ? <h2>Hai scelto il Paladino</h2> : <h2>Hai scelto il Mago</h2>}
            {hero === HERO.PALADIN && <h3>Nella luce del sole brillante, un paladino emerge, 
            ...
            {hero === HERO.MAGE && <h3>Le mani della maga sono agili e delicate, ma vibrano 
